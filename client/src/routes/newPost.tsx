			...
			<PostMaker dark={dark ? 1 : 0} className='l1 col-md-8 col-xl-6 mx-auto text-start text-md-center'>
					...
					<Fragment>
						...
						{isSubmitted && fail && (
							<main className='alert alert-danger' role='alert'>
								...
								<p>
									Something went wrong while creating the new blog post. Check the error number above
									and cross check it with the server.
								</p>
							</main>
						)}
					</Fragment>
				...
				{!loading && !loggedIn && (
					<main className='alert alert-danger' role='alert'>
						...
						<p>
							You need to be logged in to the API to use this page. There is only one valid login for the
							API, and that's for me. If you are reading this, you most likely at the wrong place. Return
							to the home page and continue the visit.
						</p>
					</main>
				)}
			</PostMaker>
